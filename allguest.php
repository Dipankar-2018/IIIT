                    ...
                    <td>
                        <?php
                         ...
                         if($bkg_row['status'] == 1): ?>
                          ...
                          <a class="btn btn-primary btn-sm" href="code.php?sign_out=<?php echo $bkg_row['Bid']; ?>"> <i class="fas fa-trash"></i>Complete Stay</a>

                         <?php elseif($bkg_row['status'] == 4): ?>                      

                          <h6>Stay completed</h5>
                         <?php endif; ?>
                    </td>
               </tbody>
            <?php endwhile; ?>
